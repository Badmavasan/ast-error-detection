...
VA_EXPRESSION_ASSIGNMENT_TO_VARIABLE_ERROR = "VA_EXPRESSION_ASSIGNMENT_TO_VARIABLE_ERROR"
...
FUNCTION_DEFINITION_NAME_ERROR = "FUNCTION_DEFINITION_NAME_ERROR"
FUNCTION_DEFINITION_UNNECESSARY_PARAMETER = "FUNCTION_DEFINITION_UNNECESSARY_PARAMETER"
FUNCTION_DEFINITION_MISSING_PARAMETER = "FUNCTION_DEFINITION_MISSING_PARAMETER"
FUNCTION_DEFINITION_MISSING_RETURN = "FUNCTION_DEFINITION_MISSING_RETURN"
FUNCTION_DEFINITION_BODY_ERROR = "FUNCTION_DEFINITION_BODY_ERROR"

# DECLARED FUNCTION CALL ERRORS (calls to functions defined in the same code)
DECLARED_FUNCTION_CALL_MISSING = "DECLARED_FUNCTION_CALL_MISSING"
DECLARED_FUNCTION_CALL_UNNECESSARY = "DECLARED_FUNCTION_CALL_UNNECESSARY"
DECLARED_FUNCTION_CALL_INCORRECT_NUMBER_OF_PARAMETERS = "DECLARED_FUNCTION_CALL_INCORRECT_NUMBER_OF_PARAMETERS"
DECLARED_FUNCTION_CALL_INCORRECT_PARAMETER = "DECLARED_FUNCTION_CALL_INCORRECT_PARAMETER"
DECLARED_FUNCTION_CALL_INCORRECT_POSITION = "DECLARED_FUNCTION_CALL_INCORRECT_POSITION"
...
F_CALL_INCORRECT_POSITION_COULEUR = "F_CALL_INCORRECT_POSITION_COULEUR"
...
EXP_ERROR_OPERATION = "EXP_ERROR_OPERATION"  # umbrella: any error on an existing operation expression (operands OR operator)
EXP_ERROR_OPERANDS = "EXP_ERROR_OPERANDS"   # operation present, problem with its operands (wrong value, missing/extra operand)
EXP_ERROR_OPERATOR = "EXP_ERROR_OPERATOR"   # operation present, but the operator type is wrong (e.g. + instead of -)
...
ANNOTATION_TAG_INCORRECT_FUNCTION_NAME = "INCORRECT_FUNCTION_NAME"
ANNOTATION_TAG_UNNECESSARY_VAR = "UNNECESSARY_VAR"
ANNOTATION_TAG_UNNECESSARY_CONST_VALUE = "UNNECESSARY_CONST_VALUE"
...
# All native/built-in function names that already have dedicated error rules.
# Any call whose function name is NOT in this set is treated as a call to a
# user-declared (student-defined) function.
KNOWN_BUILTIN_FUNCTION_NAMES = frozenset({
    "print", "range",
    "avancer", "tourner", "couleur", "arc",
...
# Function definition context helpers
# Matches any context where the error lives INSIDE a function (something after "Function:")
ANNOTATION_CONTEXT_FUNCTION_DEFINITION_BODY = r"Function:.*>"
# Present in paths for function definition parameter nodes (ast.arguments wrapper)
ANNOTATION_CONTEXT_FUNCTION_ARGUMENTS = "arguments"
